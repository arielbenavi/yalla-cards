...
export const VERBS: Verb[] = [
  ...
  },
  {
    ...
    binyan: "בניין 2 (II)",
    past: {
      ana: { translit: "וַקַפֵת", arabic: "وقفت" },
      inta: { translit: "וַקַפֵת", arabic: "وقفت" },
      inti: { translit: "וַקַפְתִי", arabic: "وقفتي" },
      huwwe: { translit: "וַקַף", arabic: "وقف" },
      hiyye: { translit: "וַקַפַת", arabic: "وقفت" },
      ihna: { translit: "וַקַפְנַא", arabic: "وقفنا" },
      intu: { translit: "וַקַפְתוּ", arabic: "وقفتوا" },
      hum: { translit: "וַקַפוּ", arabic: "وقفوا" },
    },
    present: {
      ana: { translit: "בַּוַקִף", arabic: "بوقف" },
      inta: { translit: "בִּתְוַקִף", arabic: "بتوقف" },
      inti: { translit: "בִּתְוַקְפִי", arabic: "بتوقفي" },
      huwwe: { translit: "בִּוַקִף", arabic: "بيوقف" },
      hiyye: { translit: "בִּתְוַקִף", arabic: "بتوقف" },
      ihna: { translit: "מִנְוַקִף", arabic: "منوقف" },
      intu: { translit: "בִּתְוַקְפוּ", arabic: "بتوقفوا" },
      hum: { translit: "בִּוַקְפוּ", arabic: "بيوقفوا" },
    },
    imperative: {
      inta: { translit: "וַקִף", arabic: "وقف" },
      inti: { translit: "וַקְפִי", arabic: "وقفي" },
      intu: { translit: "וַקְפוּ", arabic: "وقفوا" },
    },
    participle: {
    ...
    notes:
      "זוג מינימלי עם בניין 1: וִקֵף = עמד פיזית; וַקַּף = עצר מישהו/משהו. הפועל המרכזי לחניה ולעצירת רכב. בבניין 2 אין א׳ תחילית בציווי.",
    flags: [
      "gemination — בניין 2 אמור להיות מוכפל לאורך הנטייה (waqqaf / bwaqqif), אבל chatifai השמיט את הדגש ב-ק כמעט בכל התאים בעמודה העברית. צריך אישור על מיקום הדגש.",
    ],
  },
  {
    root: "اتعلّم",
  ...
  },
  {
    ...
    past: {
      ...
      ihna: { translit: "לַעַנְנַא", arabic: "لعنا" },
    ...
    flags: [
      "past.ihna — העמודות סותרות: העברית לַעַנְנַא עם שתי נ׳, הערבית لعنا עם נ׳ אחת. צפוי لعنّا. צריך הכרעה של chatifai.",
    ],
  },
  {
    root: "حكم",
    ...
    present: {
      ...
      inta: { translit: "בִּתְחְכֻּם", arabic: "بتحكم" },
      inti: { translit: "בִּתְחְכְּמִי", arabic: "بتحكمي" },
      huwwe: { translit: "בִּחְכֻּם", arabic: "بيحكم" },
      hiyye: { translit: "בִּתְחְכֻּם", arabic: "بتحكم" },
      ihna: { translit: "מִנְחְכֻּם", arabic: "منحكم" },
      intu: { translit: "בִּתְחְכְּמוּ", arabic: "بتحكموا" },
    ...
    notes:
      "שופטים מישהו (מושא ישיר) אבל שולטים ב- (עַלַא). חַאכֵּם משמש גם כשם עצם: מושל/שליט. בינוני פעול מַחְכּוּם = גם אסיר שנגזר דינו. קשור ל-אִלְמַחְכַּמֵה (בית משפט).",
    flags: [
      "present.ana — ההסבר של chatifai אומר בֻּחְכֻּם אבל הטבלה נותנת בַּחְכֻּם; הפרוזה והטבלה סותרות.",
      "present.inta/hiyye — בִּתְחְכֻּם עם שווא ב-ח יוצר רצף של שלושה עיצורים, בניגוד ל-בְּתִלְעַן שנתן לפועל מקביל באותו בניין.",
    ],
  },
];
